...
class MagicSquareGenerator {
  generate(size) {
    ...
    do {
      square = [];
      let initialRow = generator.generate(size);
      square.push(initialRow);
      for (let i = 1; i < size; ++i) {
        square.push(generator.generate(size));
        // TODO optimize to no  generate the same numbers in same order twice?
        console.log(square);
      }
...
let magicSquareGenerator = new MagicSquareGenerator();
let magicSquare = magicSquareGenerator.generate(2);
